...
class bbps_support_urgent_topics_widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		<p> Administrators <input class="checkbox" type="checkbox" <?php checked( $instance['show_urgent_list_admin'], 'on' ); ?>
								  name="<?php echo $this->get_field_name( 'show_urgent_list_admin' ); ?>"/></p>

		<p> Moderators <input class="checkbox" type="checkbox" <?php checked( $instance['show_urgent_list_mod'], 'on' ); ?>
							  name="<?php echo $this->get_field_name( 'show_urgent_list_mod' ); ?>"/></p>

		<p> Site Users <input class="checkbox" type="checkbox" <?php checked( $instance['show_urgent_list_user'], 'on' ); ?>
							  name="<?php echo $this->get_field_name( 'show_urgent_list_user' ); ?>"/></p>
