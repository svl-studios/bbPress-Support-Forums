...
class bbps_support_resolved_count_widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		if ( function_exists( 'bbps_add_support_forum_features' ) ) {
			...
			<p> Display Total Topic Count: <input class="checkbox" type="checkbox" <?php checked( $instance['show_total'], 'on' ); ?>
												  name="<?php echo $this->get_field_name( 'show_total' ); ?>"/></p><p> This will display the total number of
				topics in your forums </p>

			<p> Display Resolved Topic Count: <input class="checkbox" type="checkbox" <?php checked( $instance['show_resolved'], 'on' ); ?>
													 name="<?php echo $this->get_field_name( 'show_resolved' ); ?>"/></p><p> This will display the total number
				of resolved topics in your forums </p>

			<p>Text Before Total: <input class="widefat" name="<?php echo $this->get_field_name( 'text_before_total' ); ?>" type="text"
										 value="<?php echo esc_attr( $text_before_total ); ?>"/> The text you would like to display before the total topics
				count eg: Our Forums have </p>

			<p>Text After Total: <input class="widefat" name="<?php echo $this->get_field_name( 'text_after_total' ); ?>" type="text"
										value="<?php echo esc_attr( $text_after_total ); ?>"/> The text you would like to display after the total topics count
				eg: topics in total </p>
			<p>Text Before Resolved Total: <input class="widefat" name="<?php echo $this->get_field_name( 'text_before_resolved' ); ?>" type="text"
												  value="<?php echo esc_attr( $text_before_resolved ); ?>"/> The text you would like to display before the
				resolved topic count eg: We have </p>

			<p>Text After Resolved Total: <input class="widefat" name="<?php echo $this->get_field_name( 'text_after_resolved' ); ?>" type="text"
												 value="<?php echo esc_attr( $text_after_resolved ); ?>"/> The text you would like to display after the resolved
				topic count eg: topics that are resolved </p>
