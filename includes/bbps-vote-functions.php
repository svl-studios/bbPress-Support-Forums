					...
					<div class="well">
						<form id="bbps-topic-vote-feature" name="bbps_support_feature" action="" method="post">
							...
							<div>
								...
								<input type="text" name="bbps_topic_feature_funding_paid"
									   value="<?php echo get_post_meta( $topic_id, '_bbps_topic_feature_funding_paid', true ); ?>" size="5">
								paid of
								<input type="text" name="bbps_topic_feature_funding"
									   value="<?php echo get_post_meta( $topic_id, '_bbps_topic_feature_funding', true ); ?>" size="5">
								total
							...
							<?php } else { ?>
								...
								<form class="form-inline" role="form" method="post">
									<input type="hidden" name="make_contribution_title"
										   value="<?php echo htmlspecialchars( bbp_get_topic_title( $topic_id ) ); ?>">
									<input type="hidden" name="make_contribution"
										   value="<?php echo htmlspecialchars( bbp_get_topic_permalink( $topic_id ) ); ?>">
...
function dtbaker_bbps_feature_requests_parse_args( $args ) {
	...
	} elseif ( isset( $GLOBALS['bbps_feature_request_params']['type'] ) && $GLOBALS['bbps_feature_request_params']['type'] == 'new' ) {
